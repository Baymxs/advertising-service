package ru.nsu.bayramov.advertisingservice.config;
...
public class SwaggerConfig {
    ...
    private static final String TITLE = "ADVERSTING SERVICE REST API";
    private static final String DESCRIPTION = "RESTful API for advertising service";

    @Bean
    public Docket teamCftApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("ru.nsu.bayramov.advertisingservice"))
                .paths(regex("/api.*"))
                .build()
                .apiInfo(apiInfo());
    }
